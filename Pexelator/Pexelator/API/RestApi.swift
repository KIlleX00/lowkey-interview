...
/// A structure conforming to the `HTTPResponseHeadersDecodable` protocol that does not process HTTP response headers.
///
/// `EmptyResponseHeadersDecodable` provides a minimal implementation of the `HTTPResponseHeadersDecodable` protocol.
/// This structure can be used as a placeholder or default implementation where header processing is not required.
struct EmptyResponseHeadersDecodable: HTTPResponseHeadersDecodable {
    init(headers: [AnyHashable : Any]) { }
}
